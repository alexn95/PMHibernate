...
public class ProjectTests {
    ...
    public void testA() {
        ...
        Assert.assertEquals(ResultType.SQL_INTEGRITY_CONSTRAIN_EXCEPTION, dataProvider.saveRecord(project, EntryType.PROJECT).getResult());
        Assert.assertEquals(ResultType.SQL_INTEGRITY_CONSTRAIN_EXCEPTION, dataProvider.saveRecord(fakeProject, EntryType.PROJECT).getResult());
